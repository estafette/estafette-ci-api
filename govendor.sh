...
govendor fetch github.com/estafette/estafette-ci-manifest@0.1.55-explore-trigger-definition
govendor fetch github.com/estafette/estafette-ci-contracts@0.0.99