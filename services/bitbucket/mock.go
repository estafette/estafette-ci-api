...
type MockService struct {
	...
	IsAllowedOwnerFunc            func(repository bitbucketapi.Repository) (isAllowed bool, organizations []*contracts.Organization)
}
...
func (s MockService) IsAllowedOwner(repository bitbucketapi.Repository) (isAllowed bool, organizations []*contracts.Organization) {
	if s.IsAllowedOwnerFunc == nil {
		return
	}
	return s.IsAllowedOwnerFunc(repository)
}
