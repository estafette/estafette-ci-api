...
func (c *logCheckClient) Check(ctx context.Context, opts ...grpc.CallOption) (LogCheck_CheckClient, error) {
	stream, err := c.cc.NewStream(ctx, &LogCheck_ServiceDesc.Streams[0], "/migrationpb.LogCheck/Check", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *healthClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/migrationpb.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Health_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/migrationpb.Health/Check",
	}
