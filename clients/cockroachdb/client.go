...
func (c *client) UpdateBuildStatus(ctx context.Context, repoSource, repoOwner, repoName string, buildID string, buildStatus contracts.Status) (err error) {
	...
	query := psql.
		...
		Suffix("RETURNING id, repo_source, repo_owner, repo_name, repo_branch, repo_revision, build_version, build_status, labels, release_targets, manifest, commits, triggers, inserted_at, started_at, updated_at, EXTRACT(EPOCH FROM (COALESCE(started_at, inserted_at) - inserted_at)), EXTRACT(EPOCH FROM (updated_at - COALESCE(started_at, inserted_at))), triggered_by_event, groups, organizations")
...
func (c *client) UpdateReleaseStatus(ctx context.Context, repoSource, repoOwner, repoName string, releaseID string, releaseStatus contracts.Status) (err error) {
	...
	query := psql.
		...
		Suffix("RETURNING id, repo_source, repo_owner, repo_name, release, release_action, release_version, release_status, inserted_at, started_at, updated_at, EXTRACT(EPOCH FROM (COALESCE(started_at, inserted_at) - inserted_at)), EXTRACT(EPOCH FROM (updated_at - COALESCE(started_at, inserted_at))), triggered_by_event, groups, organizations")
...
func (c *client) UpdateBotStatus(ctx context.Context, repoSource, repoOwner, repoName string, botID string, botStatus contracts.Status) (err error) {
	...
	query := psql.
		...
		Suffix("RETURNING id, repo_source, repo_owner, repo_name, bot, bot_status, inserted_at, started_at, updated_at, EXTRACT(EPOCH FROM (COALESCE(started_at, inserted_at) - inserted_at)), EXTRACT(EPOCH FROM (updated_at - COALESCE(started_at, inserted_at))), triggered_by_event, groups, organizations")
...
func (c *client) GetPipelineRecentBuilds(ctx context.Context, repoSource, repoOwner, repoName string, optimized bool) (builds []*contracts.Build, err error) {
	...
	query := psql.
		Select("a.id, a.repo_source, a.repo_owner, a.repo_name, a.repo_branch, a.repo_revision, a.build_version, a.build_status, a.labels, a.release_targets, a.manifest, a.commits, a.triggers, a.inserted_at, a.started_at, a.updated_at, EXTRACT(EPOCH FROM (COALESCE(a.started_at, a.inserted_at) - a.inserted_at)), EXTRACT(EPOCH FROM (a.updated_at, COALESCE(a.started_at, a.inserted_at))), a.triggered_by_event").
...
func (c *client) GetBuildsDuration(ctx context.Context, filters map[api.FilterType][]string) (totalDuration time.Duration, err error) {
	...
	query :=
		sq.StatementBuilder.PlaceholderFormat(sq.Dollar).
			Select("SUM(EXTRACT(EPOCH FROM (updated_at,inserted_at)))").
			From("builds a")
...
func (c *client) GetPipelineBuildsDurations(ctx context.Context, repoSource, repoOwner, repoName string, filters map[api.FilterType][]string) (durations []map[string]interface{}, err error) {
	...
	innerquery :=
		sq.StatementBuilder.PlaceholderFormat(sq.Dollar).
			Select("a.inserted_at, EXTRACT(EPOCH FROM (COALESCE(a.started_at, a.inserted_at) - a.inserted_at)) AS pending_duration, EXTRACT(EPOCH FROM (a.updated_at, COALESCE(a.started_at, a.inserted_at))) as duration").
			From("builds a").
			Where(sq.Eq{"a.repo_source": repoSource}).
			Where(sq.Eq{"a.repo_owner": repoOwner}).
			Where(sq.Eq{"a.repo_name": repoName}).
...
func (c *client) GetPipelineReleasesDurations(ctx context.Context, repoSource, repoOwner, repoName string, filters map[api.FilterType][]string) (durations []map[string]interface{}, err error) {
	...
	innerquery :=
		sq.StatementBuilder.PlaceholderFormat(sq.Dollar).
			Select("a.inserted_at, a.release, a.release_action, EXTRACT(EPOCH FROM (COALESCE(a.started_at, a.inserted_at) - a.inserted_at)) as pending_duration, EXTRACT(EPOCH FROM (a.updated_at, COALESCE(a.started_at, a.inserted_at))) as duration").
			From("releases a").
			Where(sq.Eq{"a.repo_source": repoSource}).
			Where(sq.Eq{"a.repo_owner": repoOwner}).
			Where(sq.Eq{"a.repo_name": repoName}).
...
func (c *client) GetPipelineBotsDurations(ctx context.Context, repoSource, repoOwner, repoName string, filters map[api.FilterType][]string) (durations []map[string]interface{}, err error) {
	...
	innerquery :=
		sq.StatementBuilder.PlaceholderFormat(sq.Dollar).
			Select("a.inserted_at, a.bot, EXTRACT(EPOCH FROM (COALESCE(a.started_at, a.inserted_at) - a.inserted_at)) as pending_duration, EXTRACT(EPOCH FROM (a.updated_at, COALESCE(a.started_at, a.inserted_at))) as duration").
			From("bots a").
			Where(sq.Eq{"a.repo_source": repoSource}).
			Where(sq.Eq{"a.repo_owner": repoOwner}).
			Where(sq.Eq{"a.repo_name": repoName}).
...
func (c *client) selectPipelinesQuery() sq.SelectBuilder {
	...
	return psql.
		Select("a.pipeline_id, a.repo_source, a.repo_owner, a.repo_name, a.repo_branch, a.repo_revision, a.build_version, a.build_status, a.labels, a.release_targets, a.manifest, a.commits, a.triggers, a.archived, a.inserted_at, a.started_at, a.updated_at, EXTRACT(EPOCH FROM (COALESCE(a.started_at, a.inserted_at) - a.inserted_at)), EXTRACT(EPOCH FROM (a.updated_at, COALESCE(a.started_at, a.inserted_at))), a.last_updated_at, a.triggered_by_event, a.extra_info, a.groups, a.organizations").
		From("computed_pipelines a")
}
...
func (c *client) selectReleasesQuery() sq.SelectBuilder {
	...
	return psql.
		Select("a.id, a.repo_source, a.repo_owner, a.repo_name, a.release, a.release_action, a.release_version, a.release_status, a.inserted_at, a.started_at, a.updated_at, EXTRACT(EPOCH FROM (COALESCE(a.started_at, a.inserted_at) - a.inserted_at)), EXTRACT(EPOCH FROM (a.updated_at, COALESCE(a.started_at, a.inserted_at))), a.triggered_by_event, a.groups, a.organizations").
		From("releases a")
}
...
func (c *client) selectBotsQuery() sq.SelectBuilder {
	...
	return psql.
		Select("a.id, a.repo_source, a.repo_owner, a.repo_name, a.bot, a.bot_status, a.inserted_at, a.started_at, a.updated_at, EXTRACT(EPOCH FROM (COALESCE(a.started_at, a.inserted_at) - a.inserted_at)), EXTRACT(EPOCH FROM (a.updated_at, COALESCE(a.started_at, a.inserted_at))), a.triggered_by_event, a.groups, a.organizations").
		From("bots a")
}
...
func (c *client) selectComputedReleasesQuery() sq.SelectBuilder {
	...
	return psql.
		Select("a.release_id, a.repo_source, a.repo_owner, a.repo_name, a.release, a.release_action, a.release_version, a.release_status, a.inserted_at, a.started_at, a.updated_at, EXTRACT(EPOCH FROM (COALESCE(a.started_at, a.inserted_at) - a.inserted_at)), EXTRACT(EPOCH FROM (a.updated_at, COALESCE(a.started_at, a.inserted_at))), a.triggered_by_event, a.extra_info, a.groups, a.organizations").
		From("computed_releases a")
}
